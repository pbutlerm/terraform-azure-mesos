...
variable "resource_group" {
	...
	default = "patrickterra-rg"
}

variable "hostname" {
	description = "VM name referenced also in storage-related names."
	default = "patrickterra-vm"
}

variable "dns_name" {
	description = " Label for the Domain Name. Will be used to make up the FQDN. If a domain name label is specified, an A DNS record is created for the public IP in the Microsoft Azure DNS system."
	default ="patrickterra-dns"
}
...
variable "private_key_path" {
	...
	default = "C:/tools/cygwin64/home/pabutler/terra-amperity/terratest1"
}

variable "public_key_path" {
	description = "Path to your SSH Public Key"
	default ="C:/tools/cygwin64/home/pabutler/terra-amperity/terratest1.pub"
}